...
public class JDBCSelect {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 입력 요소는 접속주소, MySQL계정명, MySQL비밀번호 순으로 입력합니다 (목적지인 MySQL서버 주소를 찍습니다)
			...
			// 맨 처음 ResultSet은 -1번 이라는 임시번호를 타겟으로 잡습니다
			...
			while(rs.next()) {
				// 아까 봤던것처럼 rs.get자료형 구문을 이용해 조회하는 구문을 내부에 작성하고 실행해보세요.
