...
<%-- 
	* 요청 파라미터
	...
	- 요청 파라미터는 URL주소 뒤에 ?를 붙인 이후에 [파라키터 변수명=값] 을
	  통해 서버로 데이터를 전달할 수 있습니다
	  
	- 요청 파라미터를 여러개 전달할때는 두 번째부터 &를 붙여서 나열합니다.
--%>
<%
	// post방식 전달시 한글 깨지는걸 방지(제일 윗줄에 위치해야됨)
	request.setCharacterEncoding("utf-8");
	// 클라이언트의 전송 데이터를 받아오는 법
	...
	String c = request.getParameter("weptoon");
	String d = request.getParameter("horror");
	String e = request.getParameter("terrorman");
%>
<!DOCTYPE html>
<html>
<head>
